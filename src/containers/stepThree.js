...
const StepThree = () => {
  ...
  const addXAxis = (xScale, svg) => {
    ...
    d3.selectAll('g#x-axis')
      .append('path',)
      .attr('d', "M1324.89 24L1326.6 13.6971L1337 12L1326.6 10.3029L1324.89 -5.96046e-08L1323.18 10.3029L1312.78 12L1323.18 13.6971L1324.89 24Z")
  ...
  const addYAxis = (yScale, svg) => { 
    ...
    d3.selectAll('g#y-axis')
      .append('path',)
      .attr('d', "M12.03 28.3467L13.7141 16.1796L24.015 14.1702L13.7099 12.1717L11.9999 0.00633188L10.3158 12.1735L0.0149614 14.1828L10.32 16.1814L12.03 28.3467Z")
      .attr("fill", "#8b8b8b")
